...
<div class="group-info-body-wrap">
	...
	<div class="-self">
		...
		<div class="-info">
			...
			<span class="-modify" @click="show()">modify</span>
		</div>
		<div class="-notice">
		</div>
	</div>
	<div class="-bar"></div>
	<div class="-del" @click="del()">leave room</div>
	<div class="-bar"></div>
	<div class="-bar"></div>
</div>
<dialog v-if="isShow" :fast-close="false">
	<div class="modify-box">
		<div class="-header" @click="changeColor()">
			...
			<span class="-notice">click to change color</span>
		</div>
		<div class="-name">
			<label>nick name in room：</label>
			<input type="text" v-model="name" placeholder="10 digit length">
		</div>
		<div class="-weichat">
			<label>my ID：</label>
			<input type="text"v-model="weichat" placeholder="private chart to get ">
		</div>
		<div class="-save">
			<span class="-btn" @click="save()">save</span>
		</div>
	</div>
</dialog>
<dialog v-if="isShowF">
	<div class="f-info">
		...
		<div class="-weichat">
			<label>my id：</label>
			<input disabled="true" type="text"v-model="fweichat" placeholder="ask by yourself in room">
		</div>
		<div class="-save">
			<span class="-btn" @click="closeF()">close</span>
		</div>
	</div>
</dialog>
...
export default{
	...
	ready(){
		...
		if(!localStorage){
			alert('not support save message in local')
			return
		}
